                ...
                <div className="latest-news">
                    <div>
                        ...
                        <div className="small-topic">
                            ...
                            <div>
                                <h4>Why some students might not pass the exam</h4>
                                <p>Robart Henry</p>
                            </div>
                        </div>
                        <div className="small-topic">
                            ...
                            <div>
                                <h4>Necessary steps to master in English</h4>
                                <p>Max Bosh</p>
                            </div>
                        </div>
                        <div className="small-topic">
                            ...
                            <div>
                                <h4>Grammar mistakes you should avoid</h4>
                                <p>Robart Henry</p>
                            </div>
                        </div>
                    </div>
